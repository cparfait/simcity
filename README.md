...
**Qui est le titulaire : le référentiel fait foi.** Partout où le module nomme quelqu'un (colonne *Titulaire* des consommations, top 10 du tableau de bord, alertes, fiche d'une ligne), c'est le **titulaire SimCity** qui est affiché ; le nom porté par la facture n'apparaît qu'à défaut, ou en second (📄) quand il diverge. C'est le référentiel qui décide des attributions, la facture ne fait que les refléter — souvent avec du retard, un nom de service ou un libellé de matériel. Seul l'onglet **Rapprochement des noms** compare les deux à parts égales, puisque c'est son objet.
